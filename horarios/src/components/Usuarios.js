      ...
      .catch(function (error) {
        if (error.response) {
          if (error.response.data.noUser) {
            err(`No User:  ${error.response.data.noUser}`);
          }
          if (error.response.data.isStaff) {
            err(`Already Staff:  ${error.response.data.isStaff}`);
          }
          if (error.response.data.unauthorized) {
            err(`Not Authorized:  ${error.response.data.unauthorized}`);
          }
    ...
    await axios(config)
      ...
      .catch(function (error) {
        if (error.response) {
          ...
          if (error.response.data.notStaff) {
            err(`Not Staff:  ${error.response.data.notStaff}`);
          }
          if (error.response.data.unauthorized) {
            err(`Not Authorized:  ${error.response.data.unauthorized}`);
          }

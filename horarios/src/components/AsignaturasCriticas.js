                ...
                <div className="card ">
                  ...
                  <div className="card-body">
                    ...
                    <p className="card-text">
                      ...
                      podras priorizar los ramos y secciones que quieras que
                      tengan una mayor prioridad al armar tu horario{" "}
                    </p>
                    <br />
                    <Link
                      className="nav-link text-center"
                      to={{ pathname: "/users/usr/priorizarRamos/priorizar" }}
                      style={{ color: "#0d6efd" }}
                    >
                      {" "}
                      Presiona Aquí{" "}
                ...
                <div className="card ">
                  ...
                  <div className="card-body">
                    ...
                    <p className="card-text">
                      ...
                      visualizar tu avance curricular, los ramos que puedes
                      tomar en este semestre y los ramos críticos de tu malla
                    </p>

                    <Link
                      className="nav-link text-center"
                      to={{ pathname: "/users/usr/PERT" }}
                      style={{ color: "#0d6efd" }}
                    >
                      {" "}
                      Presiona Aquí{" "}

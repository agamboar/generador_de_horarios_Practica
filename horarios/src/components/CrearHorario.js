              ...
              <div className="row">
                ...
                <div className="col-sm-4 custom3">
                  <div className="card custom4">
                    ...
                    <div className="card-body">
                      <h5 className="card-title text-center">
                        Ingreso de Avance Curricular Excel Pt.1
                      </h5>
                      <p className="card-text">
                        En los siguientes link podras descargar la malla que te
                        corresponde, para que la puedas rellenar con tu avance
                        curricular y ingresarla en el siguiente punto.
                      </p>
                      <br />
                ...
                <div className="col-sm-4 custom3">
                  <div className="card custom4">
                    ...
                    <div className="card-body">
                      <h5 className="card-title text-center">
                        Ingreso de Avance Curricular Excel Pt.2
                      </h5>
                      <p className="card-text">
                        En la siguiente casilla debes ingresar el excel que
                        contiene tú avance curricular logrado durante la
                        carrera, adjuntalo en la casilla continua.
                      </p>
                      <br />

        ...
        return (
            ...
            <div className="container">
                ...
                <div className="row row-cols-10 align-items-start">
                    <div className="col col-md-1"> </div>  
                    <RamoP codigo = {"CIT-3310"} ramo = {"Electivo Profesional"} />      
                    <RamoP codigo = {"CIT-3311"} ramo = {"Electivo Profesional"} />      
                    <div className="col col-md-1"> </div>  
                </div>
                ...
                <div className="row row-cols-10">
                    <div className="col col-md-1"> </div>  
                    <RamoP codigo = {"CIT-3410"} ramo = {"Electivo Profesional"} />      
                    <RamoP codigo = {"CIT-3411"} ramo = {"Electivo Profesional"} />      
                    <div className="col col-md-1"> </div>  
                </div>
                ...
                <div className="row row-cols-10">
                    ...
                    <RamoP codigo = {"CIT-3412"} ramo = {"Electivo Profesional"} />      
                    <RamoP codigo = {"CIT-3413"} ramo = {"Electivo Profesional"} />      
                    <div className="col col-md-1"> 
                ...
                <div className="row row-cols-10">
                    <div className="col col-md-1"> </div> 
                    <RamoP codigo = {"CIT-3312"} ramo = {"Electivo Profesional"} />      
                    <RamoP codigo = {"CIT-3313"} ramo = {"Electivo Profesional"} />      
                    <div className="col col-md-1"> </div>                     

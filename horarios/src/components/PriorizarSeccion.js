            ...
            <div>
                ...
                <Layout>
                  ...
                  <Row>
                    ...
                    <Col flex="auto"><div style={{padding: 10, display: "flex",  justifyContent: "center"}} ><Link className="nav-link" to={{ pathname: '/users/usr/priorizarRamos' }} ><Button style={{ color:color="#616161"}}>Priorizar Ramos</Button></Link></div></Col>
                    <Col flex="auto"><div style={{padding: 10, display: "flex",  justifyContent: "flex-end"}} ><Link className="nav-link" to={{ pathname: '/users/usr/horariosPosibles' }} ><Button  style={{ color:color="#616161"}}>Generar Horario</Button></Link></div></Col>
                  </Row>

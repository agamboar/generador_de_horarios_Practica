                            ...
                            <div className="col-sm-4 ">
                                ...
                                <br/>
                                    ...
                                    <div className="card-body">
                                        ...
                                        <Link className="nav-link text-center" to={{ pathname: '/users/usr/mallas/malla2010/AvanceCurricular'}}style={{ color: '#0d6efd' }} >  Presiona Aquí   </Link>
                                    </div>
                                </div>
                            </div>
                            <div className="col-sm-4 ">
                                ...
                                <br/>
                                    ...
                                    <div className="card-body">
                                        ...
                                        <p className="card-text">En el siguiente link podras elegir la malla que te corresponde, tambien podras ver información adicional a esta y agregar tu avance curricular</p>
                                        <Link className="nav-link text-center" to={{ pathname: '/users/usr/mallas/malla2018/AvanceCurricular'}}style={{ color: '#0d6efd' }} >  Presiona Aquí   </Link>
                                    </div>
                                </div>
                            </div>
                            <div className="col-sm-4 ">
                                ...
                                <br/>
                                    ...
                                    <div className="card-body">
                                        ...
                                        <p className="card-text">En el siguiente link podras elegir la malla que te corresponde, tambien podras ver información adicional a esta y agregar tu avance curricular</p>
                                        <Link className="nav-link text-center" to={{ pathname: '/users/usr/mallas/malla2020/AvanceCurricular'}}style={{ color: '#0d6efd' }} >  Presiona Aquí   </Link>
                                    </div>
                                </div>
                            </div>

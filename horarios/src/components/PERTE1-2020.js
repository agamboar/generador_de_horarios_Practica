        ...
        return (
            ...
            <div className="container">
                ...
                <div className="row row-cols-10 align-items-start">
                    <div className="col col-md-1"> </div>  
                    <RamoE codigo = {"CBM-1000"} ramo = {"Álgebra y Geometría"} />                    
                    <RamoE codigo = {"CBM-1002"} ramo = {"Álgebra Lineal"}/>      
                    <RamoE codigo = {"CBM-1005"} ramo = {"Ecuaciones Diferenciales"} />      
                    <div className="col col-md-1"> </div>  
                </div>
                ...
                <div className="row row-cols-10">
                    <div className="col col-md-1"> </div>  
                    <RamoE codigo = {"CBM-1001"} ramo = {"Cálculo I"} />      
                    <RamoE codigo = {"CBM-1003"} ramo = {"Cálculo II"} />      
                    <RamoE codigo = {"CBM-1006"} ramo = {"Cálculo III"} />                       
                    <div className="col col-md-1"> </div>  
                </div>
                ...
                <div className="row row-cols-10">
                    ...
                    <RamoE codigo = {"CBQ-1000"} ramo = {"Química"} />      
                    <RamoE codigo = {"CBF-1000"} ramo = {"Mecánica"} />      
                    <RamoE codigo = {"CBF-1001"} ramo = {"Calor y Ondas"} />      
                    <div className="col col-md-1"> 
                ...
                <div className="row row-cols-10">
                    <div className="col col-md-1"> </div> 
                    <RamoE codigo = {"CIT-1000"} ramo = {"Programación"} />      
                    <RamoE codigo = {"CIT-1010"} ramo = {"Programación Avanzada"} />                     
                    <RamoE codigo = {"CIT-2006"} ramo = {"Estructura de Datos y Algoritmos"} />      
                    <div className="col col-md-1"> </div>                 
                </div>
                ...
                <div className="row row-cols-10">
                    <div className="col col-md-1"> </div> 
                    <RamoE codigo = {"FIC-1000"} ramo = {"Comunicación para la Ingeniería"} />      
                    <RamoE codigo = {" - "} ramo = {"Minor / CFG"} />                     
                    <RamoE codigo = {"CIT-2114"} ramo = {"Redes de Datos"} />      
                    <div className="col col-md-1"> </div>                     

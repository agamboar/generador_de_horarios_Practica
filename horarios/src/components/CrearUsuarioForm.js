      ...
      .catch(function (error) {
        if (error.response) {
          if (error.response.data.username) {
            notify(`usuario:  ${error.response.data.username[0]}`);
          }
          if (error.response.data.password1) {
            notify(`contraseña:  ${error.response.data.password1[0]}`);
          }
          if (error.response.data.password2) {
            notify(`contraseña 2:  ${error.response.data.password2[0]}`);
          }
          if (error.response.data.email) {
            notify(`email:  ${error.response.data.email[0]}`);
          }
